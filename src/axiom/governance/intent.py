...
REGISTERED_INTENTS: set[str] = {
    ...
    # tool dispatch — every chat / MCP / CLI tool call through
    # axiom.infra.tool_gateway consults GUARD with this verb (P5); the tool
    # itself is the resource (tool://<name>), see axiom.infra.authority.
    "tool.invoke",
    # federation
    "federation.forward",
