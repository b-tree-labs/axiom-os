...
def dispatch_tool(
    *,
    ...
    Args:
        ...
        surface: Dispatch surface (``"cli" | "mcp" | "agent_tool"``), stamped
            into the ``tool.pre_invoke`` payload so a surface-scoped authority
            rule can match it (ADR-114 §3). Empty leaves the call surface-less.
