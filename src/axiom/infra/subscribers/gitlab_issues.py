...
Config env vars:
    ...
    AXIOM_GITLAB_PROJECT — Project path (default: empty, must be configured)
"""
...
from axiom.infra.subscribers.issue_provider import IssueProvider, IssueProviderFactory
...
class GitLabIssueProvider(IssueProvider):
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        self._project_path = (
            config.get("project")
            or getenv("AXIOM_GITLAB_PROJECT", _DEFAULT_PROJECT)
        )
        self._gl = None
        self._project = None
