...
_ABSTENTION_MARKERS = (
    ...
    "not indexed",
    "no documents",
    # refusal phrasings the model actually emits when retrieval is empty
    "cannot answer",
    "can't answer",
    "unable to answer",
    "none of the passages",
    "not contain",          # "do/does not contain", "passages don't contain"
    "n't contain",          # "don't/doesn't contain"
    "not stated",
    "not mentioned",
    "not specified",
    "not provided",
