...
def cmd_status(args: argparse.Namespace) -> int:
    ...
    from axiom.extensions.builtins.signals.pgvector_store import VectorDB, k3d_status
    ...
    if status.get("running") or os.environ.get("AXIOM_DB_URL"):
        print("\n--- Health Check ---")
        try:
            db = VectorDB()
            db.connect()
