...
from .keychain import KeychainSecretStoreProvider
from .kubernetes import KubernetesSecretStoreProvider
from .localfile import FileSecretStoreProvider
...
def register_builtins() -> None:
    ...
    SecretStoreRegistry.register(KeychainSecretStoreProvider)
    SecretStoreRegistry.register(FileSecretStoreProvider)
