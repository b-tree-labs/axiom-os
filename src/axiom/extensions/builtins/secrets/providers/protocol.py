...
class SecretRef:
    ...
    form on code paths for safety.
        ...
        SecretRef(scheme='openbao', path='kv/data/example-host/dp1/db/password', version=None)
        >>> SecretRef.parse("env://NEUT_PG_PASSWORD")
        SecretRef(scheme='env', path='NEUT_PG_PASSWORD', version=None)
    ...
    def parse(cls, url: str) -> SecretRef:
        ...
        version = int(q.pop("version")) if "version" in q else None
