...
def _parser() -> argparse.ArgumentParser:
    ...
    reg.add_argument(
        "--site",
        help="site this connector's rows belong to (e.g. ut-triga). Conformance "
    ...
    fresh = sub.add_parser(
        "ingest-freshness",
        help="Did rows LAND? Per-stream freshness against expectations — the "
    ...
    fresh.add_argument(
        "--expect-hours",
        type=float,
        help="expected maximum age in hours, applied to every stream",
    )
