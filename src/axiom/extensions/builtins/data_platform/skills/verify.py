...
EXTRACTION_REMEDIATION = (
    "extraction deps missing: pip install 'axiom-os-lm[extraction]'"
)
...
__all__ = [
    ...
    "check_extraction_deps", "missing_extraction_deps",
    "EXTRACTION_DEPS", "EXTRACTION_REMEDIATION",
]
