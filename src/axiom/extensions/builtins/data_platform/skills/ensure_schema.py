...
def run(params: dict[str, Any], ctx: SkillContext) -> SkillResult:
    ...
    try:
        with conn.cursor() as cur:
            ...
            # The recovery lives in `conformance` rather than here, because the
            # site's nightly conformance applies this same DDL directly and
            # never reaches this skill. It spent three consecutive nights
            # failing on a refusal this function already knew how to handle.
            recreated = apply_conformance_ddl(cur, statements)
