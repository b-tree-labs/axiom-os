# SKILL: data.troubleshoot

**Owner:** `axi data troubleshoot` · invocable through SkillRegistry (ADR-056)
...
See `troubleshoot.py` for the function body. CLI verb `axi data troubleshoot` is a thin
...
through `ctx.registry.invoke("data.troubleshoot", params, ctx)`.

## Inputs / Outputs

See the function docstring at `axiom.extensions.builtins.data_platform.skills.troubleshootun`.
