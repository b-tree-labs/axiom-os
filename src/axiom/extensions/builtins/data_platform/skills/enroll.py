...
#:
#: Imported rather than restated: this module and ``daq.envelope`` used to hold
#: separate copies of the same tuple, which is one edit away from a row being
#: admissible at enrollment and rejected at ingest, or the reverse.
from ..daq.envelope import MODELLED_CLASSES, SOURCE_CLASSES
