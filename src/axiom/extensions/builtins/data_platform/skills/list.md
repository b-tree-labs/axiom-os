...
**Owner:** `axi data list` · invocable through SkillRegistry (ADR-056)
...
See `list.py` for the function body. CLI verb `axi data list` is a thin
...
through `ctx.registry.invoke("data.list", params, ctx)`.

## Inputs / Outputs

See the function docstring at `axiom.extensions.builtins.data_platform.skills.listun`.
