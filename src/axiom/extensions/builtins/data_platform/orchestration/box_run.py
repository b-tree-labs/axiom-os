...
# Kind-agnostic alias: the orchestrator only calls source.list_changed /
# source.fetch, so it works over any IngestSource. ``run_box_to_rag`` is
# kept as a back-compat alias for existing callers.
run_source_to_rag = run_box_to_rag

__all__ = ["BoxRunReport", "run_box_to_rag", "run_source_to_rag"]
