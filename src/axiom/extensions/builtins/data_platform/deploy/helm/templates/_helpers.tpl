...
# are NOT baked into env. They live in connector TOMLs under
# `$AXI_STATE_DIR/plinth/connectors/`, mounted from the connectors
# ConfigMap (see connectors-configmap.yaml). The Dagster sensor
# enumerates them at runtime — one source per connector.
- name: AXI_STATE_DIR
  value: "/var/lib/axiom/state"
