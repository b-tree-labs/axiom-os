...
# Worker-unique (see test_rag_integration.py): a shared prefix lets one
# xdist worker's _clean_prefix DELETE rows another worker's in-flight
# test just wrote — including across FILES, since both integration files
# used the same literal prefix.
