...
def downgrade() -> None:
    op.drop_column("schedule_definition", "anchor_offset_seconds", schema="schedule")
    op.drop_column("schedule_definition", "anchor_to", schema="schedule")
    op.drop_column("schedule_definition", "anchor_time_slot_id", schema="schedule")
