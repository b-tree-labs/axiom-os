...
def downgrade() -> None:
    op.drop_table("schedule_blackout", schema="schedule")
    op.drop_column("schedule_definition", "compliance_action", schema="schedule")
    op.drop_column("schedule_definition", "compliance_window_seconds", schema="schedule")
