...
### Doc Standards
- Audit `docs/` against `docs/conventions/doc-standards.md` (`axi hygiene stat docs`)
- Detect loose root files, kind-prefix violations, ADR collisions, retired folders, broken links
- Propose relocations/renames through propose → approve (report-only detection)
