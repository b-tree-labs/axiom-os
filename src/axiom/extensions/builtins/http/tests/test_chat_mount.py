...
def test_composed_app_openai_completions_raw_query(monkeypatch):
    # The raw bypass is a deployment capability, refused unless enabled: it
    # skips retrieval, the system prompt and tool routing. The refusal path is
    # covered in tests/chaos/test_raw_bypass_gate.py.
