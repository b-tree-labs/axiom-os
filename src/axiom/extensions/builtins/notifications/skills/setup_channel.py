...
def run(params: dict[str, Any], ctx: SkillContext) -> SkillResult:
    ...
    if not url:
        ...
        return SkillResult(
            ...
            value={
                ...
                "next": (
                    f"{_brand_cli()} notifications setup {channel} "
    ...
    return SkillResult(
        ...
        value={
            ...
            "expected_channels": sorted(expected),
            "guarded_by": f"{_brand_cli()} doctor — 'HERALD declared channels registered'",
            "prove_it": (
                f"{_brand_cli()} notifications send --recipient <who> --priority low "
