...
# Read-only verbs safe to project onto agent + MCP (ADR-072 §4.9.4); the write
# verbs (cut/mode/sync/watch/pause/resume/close/...) stay CLI-only for now.
_MCP_READS = frozenset({"status", "check", "plan", "list"})
