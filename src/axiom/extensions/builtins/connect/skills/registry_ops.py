...
def install(params: dict[str, Any], ctx: Any = None) -> SkillResult:
    ...
    conn = ConnectionInstance(
        ...
        auth_mode=params.get("auth_mode", AuthMode.UNSPECIFIED),
        tenancy=params.get("tenancy", Tenancy.SINGLE),
    ...
    return SkillResult(
        ...
        value={
            ...
            "auth_mode": conn.auth_mode.value,
            "tenancy": conn.tenancy.value,
            "capability_scope": conn.capability_scope,
            ...
            "connections": [
                {
                    ...
                    "owner": c.owner,
                    "scopes": c.scopes,
                    "auth_mode": c.auth_mode.value,
                    "tenancy": c.tenancy.value,
