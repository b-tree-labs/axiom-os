    ...
    TOOLS = [
        ...
        ToolDef(
            ...
            parameters={
                "type": "object",
                "properties": {
                    "classroom_id": {"type": "string", "description": "Identifier of the classroom to act on, as returned by `classroom_list`."},
                    "queries": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": (
        ...
        ToolDef(
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "canvas_course_id": {"type": "string", "description": "The course's identifier in Canvas, which differs from the Axiom course id."},
            ...
            parameters={
                ...
                "properties": {
                    "action": {
                        ...
                        "description": (
                            "Which LMS setup step to run: 'list-providers' "
                            "lists the supported systems, 'canvas-probe' "
                            "tests credentials without saving, "
                            "'canvas-configure' saves the connection, and "
                            "'none' skips LMS integration entirely."
                        ),
                    },
                    "classroom_id": {
                        "type": "string",
        ...
        ToolDef(
            ...
            parameters={
                "type": "object",
                "properties": {
                    "course_id": {"type": "string", "description": "Identifier of the course this configuration belongs to."},
                    "rail_id": {"type": "string", "description": "Identifier of the guardrail to edit, as returned by the rail listing action."},
                    "new_yaml": {
                        "type": "string",
                        "description": (
            ...
            parameters={
                ...
                "properties": {
                    "action": {
                        ...
                        "description": (
                            "Which guardrail step to run: 'list-banks' shows "
                            "the available banks, 'add' attaches one to the "
                            "course, 'preview' shows the effect without "
                            "saving it."
                        ),
                    },
                    "course_id": {
            ...
            parameters={
                ...
                "properties": {
                    "action": {
                        ...
                        "description": (
                            "What to do with the checkpoint set: 'list' shows "
                            "the current checkpoints, 'add' and 'remove' "
                            "change them, 'skip-defaults' starts from an "
                            "empty set instead of the course defaults."
                        ),
                    },
                    "course_id": {"type": "string", "description": "Identifier of the course this configuration belongs to."},
                    "checkpoint_id": {
                    ...
                    "label": {"type": "string", "description": "Human-readable name shown for this checkpoint."},
                    "questionnaire_id": {"type": "string", "description": "Identifier of the questionnaire this checkpoint gates on."},
                    "required": {"type": "boolean", "description": "Whether the checkpoint must be completed before the course can proceed."},
                },
