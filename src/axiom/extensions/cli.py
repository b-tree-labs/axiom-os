...
def _cmd_init_legacy(args: argparse.Namespace) -> None:
    ...
    print()
    print("Next steps:")
    print(f"  {_brand_cli()} ext                    # Verify it appears")
    print(f"  {_brand_cli()} ext check {args.name}  # Validate")
    print(f"  {_brand_cli()} chat                   # Chat tools are available immediately")
