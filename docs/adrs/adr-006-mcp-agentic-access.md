...
**Implementation status:** ✅ Shipped (`src/axiom/extensions/builtins/mcp/`)
...
┌────────────────────────────────────────────────────────────────┐
│                    Axiom MCP Server                         │
│              src/axiom/extensions/builtins/mcp/            │
└───────────────────────┬────────────────────────────────────────┘
                        │ same operations
┌───────────────────────▼────────────────────────────────────────┐
│                    axiom CLI                                      │
...
- [Connections Spec](../specs/spec-connections.md) — Connection-level access for MCP tools
- [Model Routing Spec](../specs/spec-model-routing.md) — Export control for agent queries
