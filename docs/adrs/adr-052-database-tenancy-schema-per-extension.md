...
**Status:** Accepted (2026-05-29; binding — schema-per-extension via axiom.infra.db.session_for)
**Supersedes:** none
...
**Specs:** `spec-aeos-0.1.md` (the governing AEOS spec). The `[database]` manifest block follows from this ADR and is drafted forward in `spec-aeos-1.0.md` §4.x.
