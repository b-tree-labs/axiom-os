...
- **Separate leak, same class (flagged):** the data-architecture spec's "§7.3 INL
  DeepLynx Partnership" is domain/partnership content that belongs in the domain consumer,
  not the generic spec. To be relocated.
