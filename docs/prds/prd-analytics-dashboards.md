...
**Design Implication:** Dashboard architecture is streaming-first with batch fallbacks. Real-time is the default; batch processing handles historical aggregations and disaster recovery. See [ADR 007](../adrs/adr-007-streaming-first-architecture.md).
...
> **Design Decision:** Streaming-first with batch fallbacks. See [ADR 007](../adrs/adr-007-streaming-first-architecture.md)
...
**Design Decision:** Streaming-first architecture. Real-time is the default; batch for historical aggregations and fallback. See [ADR 007](../adrs/adr-007-streaming-first-architecture.md).
