...
- [Canary Nodes Tech Spec](../specs/spec-canary-nodes.md) — Implementation details, data models, API contracts
...
- [CI/CD Tech Spec](../specs/spec-cicd-and-deployment.md) — Build pipeline, container images
