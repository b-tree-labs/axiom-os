...
**Full specification:** [Model Routing Spec](../specs/spec-model-routing.md)
...
**Full specification:** [RAG Architecture Spec §8](../specs/spec-rag-architecture.md)
...
**Full specification:** [Model Routing Spec §8](../specs/spec-model-routing.md) | [Security & Access Control PRD](prd-security.md)
...
**Full specification:** [Model Routing Spec §10](../specs/spec-model-routing.md) | [Security & Access Control PRD](prd-security.md)
...
Sessions are stored in PostgreSQL (see [spec-session-store.md](../specs/spec-session-store.md)). Each session has an **owner** (the human who started it) and **delegates** (agents authorized to write).
...
### Specifications
- [RAG Architecture Spec](../specs/spec-rag-architecture.md) — Full RAG design including EC compliance
- [Model Routing Spec](../specs/spec-model-routing.md) — Router, gateway, prompt injection defense, leakage detection
- [Agent Architecture Spec](../specs/spec-agent-architecture.md) — Agent configuration and orchestration
- [Agent Architecture Spec](../specs/spec-agent-architecture.md) — Signal pipeline detail
