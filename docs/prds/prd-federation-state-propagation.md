...
**Companion:** [ADR-038 — Leader-Directed Onboarding](../adrs/adr-038-builtin-mcp-server.md) *(planned)* depends on Phase 1 of this PRD
...
- [ADR-038 — Leader-Directed Onboarding](../adrs/adr-038-builtin-mcp-server.md) *(planned)* — depends on Phase 1 of this PRD; consumes the CAPABILITY record type.
