...
>
> **Governing spec:** AEOS 0.1 ([spec-aeos-0.1.md](spec-aeos-0.1.md)) is the canonical standard and governs extension conformance; this 1.0 successor is in draft and is not yet the governing spec.
