...
def _fresh_probe_cache(monkeypatch):
    ...
    # ActionLedger defaults hmac_key from AXIOM_AUDIT_HMAC_KEY, so a developer
    # who exports it for EC-mode work would otherwise get chained records in
    # every "no key configured" test. CI never sets it; local shells do.
