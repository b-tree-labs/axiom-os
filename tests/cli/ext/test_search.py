...
def test_cli_table_output(
    ...
    # Case-insensitive: headings were normalised to lower case across every
    # table; this asserts the columns exist, not how they are capitalised.
    assert "name" in out.lower() and "latest" in out.lower()
